...
trait LoanTrait
{
    ...
    {
        return DB::table('application_stages')->where('application_id', $id)->first()->stage;
    }

    public function get_current_loan_status($id)
    {
        return DB::table('application_stages')->where('application_id', $id)->first()->status;
    }
