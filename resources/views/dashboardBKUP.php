...
<body style="margin: 0; padding: 0; word-spacing: normal; background-color: #170674cd; background-size: cover; background-position: center; background-repeat: no-repeat;">
  <div role="article" aria-roledescription="email" lang="en" style="text-size-adjust: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; background-color: linear-gradient(to right, #3020de, #170346);">
            ...
            <table role="presentation" style="width: 94%; max-width: 600px; border: none; border-spacing: 0; text-align: left; font-family: 'Basier Circle', 'montserrat', 'Helvetica', 'Arial', sans-serif; font-size: 1em; line-height: 1.37em; color: #384049;">
              ...
              <tr>
                <td style="padding: 40px 30px 30px 30px; text-align: center; font-size: 1.5em; font-weight: bold;">
                  <a href="https://app.capexfinancialservices.org" style="text-decoration: none;">
                    <img alt="Capex Finance Service" style="width: 90px; height: 60px; border: none; text-decoration: none; color: #033e75;" src="https://admin.capexfinancialservices.org/public/assets/images/logo-light.png">
                  </a>
                </td>
              </tr>
              ...
              <tr>
                <td style="padding: 30px; text-align: center; font-size: 0.75em; background-color: #ffeada; color: #384049; border: 1em solid #fff;">
                  <p style="margin: 0 0 0.75em 0; line-height: 0;">
                    <a href="https://www.linkedin.com/company/capex-financial-services/?originalSubdomain=zm" style="display: inline-block; text-decoration: none; margin: 0 5px;">
...
{{--
                  ...
                  <p style="margin: 0; font-size: 0.75rem; line-height: 1.5em; text-align: center;">
                    5840 Nanshila Road, off Great E Rd, Lusaka
                    <br>
                    @isset($actionText)
                      @slot('subcopy')
                        @lang(
