        ...
        <div class="relative flex px-10 mt-10">
            ...
            <div class="items-start justify-between p-4 md:flex-row gap-7">
                ...
                <div class="px-8 ml-4">
                    ...
                    <a href="{{ route('loan-details', ['id' => $my_loan->id]) }}" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-success border border-success rounded-full text-white transition-all duration-300 hover:bg-success/[0.85] hover:border-success/[0.85]">
                        ...
                        <span class="px-2.5 font-bold text-lg leading-[2.8]">Loan Open & Approved Successfully </span>
                    </a>
                </div>
            </div>
