        ...
        <div class="relative flex px-10 mt-10">
            ...
            <div class="items-start justify-between p-4 md:flex-row gap-7">
                ...
                <div class="px-8 ml-4">
                    ...
                    <a href="{{ route('form') }}" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-warning border border-warning rounded-full text-white transition-all duration-300 hover:bg-warning/[0.85] hover:border-warning/[0.85]">
                        ...
                        <span class="px-2.5 font-bold text-lg leading-[2.8]">Resume Loan Application</span>
                    </a>
                    </p>
                </div>
            </div>
