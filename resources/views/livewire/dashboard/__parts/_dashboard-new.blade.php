        ...
        <div class="relative flex px-10 mt-10">
            ...
            <div class="items-start justify-between p-4 md:flex-row gap-7">
                <div class="mt-4 shrink-0">
                    <div>
                        <h5 class="text-4xl font-bold text-white fw-bold">Welcome  </h5>
                ...
                <div class="px-8 ml-4">
                    ...
                    <h3 class="text-4xl font-bold text-white">Manage my Loans</h3>
                    ...
                    <a href="{{ route('form') }}" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-purple border border-purple rounded-full text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85]">
                        ...
                        <span class="px-2.5 font-bold text-lg leading-[2.8]">Apply for Loan</span>
                    </a>
                    </p>
                </div>
            </div>
