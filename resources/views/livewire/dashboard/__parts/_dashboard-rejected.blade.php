        ...
        <div style="background: #d7b3ff;" class="p-4 shadow-lg md:p-10 rounded-2xl">
            <div class="relative flex flex-col px-4 mt-4 md:flex-row md:px-10 md:mt-10">
                <div id="image_section" class="flex items-center justify-center gap-5 mb-4 md:justify-between md:mb-0">
                    <div class="relative">
                        <img src="public/app/img/welcome.jpg" width="300" style="margin-bottom: -33px" class="h-auto max-w-full" alt="Welcome Image">
                        {{-- <span class="absolute w-5 h-5 rounded-full bg-success bottom-2 ltr:right-4 rtl:left-4"></span> --}}
                    </div>
                </div>
                <div class="flex flex-col items-start justify-between p-4 gap-7">

                    <div class="px-0 md:px-8 md:ml-4">
                        <h3 class="text-2xl font-bold text-white md:text-4xl">Your recent loan application</h3>
                        <h3 class="text-2xl font-bold text-white md:text-4xl">was denied.</h3>
                        <p class="max-w-4xl mt-2 text-sm text-white md:text-base dark:text-darkmuted">
                            Please check and resolve the issues to complete this loan
                        </p>
                        <a href="{{ route('loan-details', $my_loan->id) }}" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-danger border border-danger rounded-full text-white transition-all duration-300 hover:bg-danger/[0.85] hover:border-danger/[0.85]">
                            ...
                            <span class="px-2.5 font-bold text-sm md:text-lg leading-[2.8]">Loan Request has been Denied</span>
                        </a>
                    </div>
                </div>
            </div>
