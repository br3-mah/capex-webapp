...
<div wire:ignore.self class="space-y-6">
    <div class="flex flex-wrap gap-4 mb-4">
        ...
        <div class="flex justify-between w-full gap-4">
            ...
            <div class="flex-1 min-w-[calc(50%-1rem)]">
                <label for="mydob" class="block text-sm font-medium text-blue-700">Date of Birth</label>
                <input autocomplete="off" type="text" id="mydob" name="dob" class="block w-full mt-1 border-2 border-blue-500 rounded-md shadow-sm smoothDatePicker2 form-input focus:border-blue-700 focus:ring-blue-700 sm:text-sm">
