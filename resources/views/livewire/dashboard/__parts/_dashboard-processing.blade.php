            ...
            <div class="relative flex flex-col px-4 mt-4 md:flex-row md:px-10 md:mt-10">
                ...
                <div class="flex flex-col items-start justify-between p-4 gap-7">
                    ...
                    <div class="px-0 md:px-8 md:ml-4">
                        ...
                        <a href="#" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-success border border-success rounded-full text-white transition-all duration-300 hover:bg-success/[0.85] hover:border-success/[0.85]">
