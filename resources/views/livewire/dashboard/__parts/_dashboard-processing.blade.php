        ...
        <div style="background: #d7b3ff;" class="p-4 shadow-lg md:p-10 rounded-2xl">
            <div class="relative flex flex-col px-4 mt-4 md:flex-row md:px-10 md:mt-10">
                <div id="image_section" class="flex items-center justify-center gap-5 mb-4 md:justify-between md:mb-0">
                    <div class="relative">
                        <img src="public/app/img/welcome.jpg" width="300" class="h-auto max-w-full" alt="Welcome Image">
                ...
                <div class="flex flex-col items-start justify-between p-4 gap-7">
                    <div class="mt-4 shrink-0">
                        <div>
                            <h5 class="text-3xl font-bold text-white md:text-4xl">Welcome</h5>
                    ...
                    <div class="px-0 md:px-8 md:ml-4">
                        ...
                        <a href="{{ route('loan-details', $my_loan->id) }}" class="shadow-lg inline-flex mt-6 px-4 align-middle bg-success border border-success rounded-full text-white transition-all duration-300 hover:bg-success/[0.85] hover:border-success/[0.85]">
                            ...
                            <span class="px-2.5 font-bold text-sm md:text-lg leading-[2.8]">Your Loan Application is Currently Under Review</span>
                        </a>
                    </div>
                </div>
            </div>
