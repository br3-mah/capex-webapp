<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div class="p-4 border border-gray-200 rounded-md">
            ...
            <div id="clickable" class="flex justify-center px-6 pt-5 pb-6 mt-1 transition-colors duration-200 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-gray-400">
        ...
        <div class="p-4 border border-gray-200 rounded-md">
            ...
            <div id="clickable2" class="flex justify-center px-6 pt-5 pb-6 mt-1 transition-colors duration-200 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-gray-400">
                <div class="space-y-1 text-center">
                    <svg class="w-12 h-12 mx-auto text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
        ...
        <div class="p-4 border border-gray-200 rounded-md">
            ...
            <div id="clickable3" class="flex justify-center px-6 pt-5 pb-6 mt-1 transition-colors duration-200 border-2 border-gray-300 border-dashed rounded-md cursor-pointer hover:border-gray-400">
                <div class="space-y-1 text-center">
                    <svg class="w-12 h-12 mx-auto text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
                        <path d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
