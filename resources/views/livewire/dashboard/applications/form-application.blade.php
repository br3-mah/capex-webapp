    ...
    <div class="w-full px-2" style="overflow-y: scroll; overflow-x:hidden; height:full">
            ...
            <div class="w-full py-2 pb-2 "  id="wizard" enctype="multipart/form-data">
                ...
                <div id="step1" class="w-full max-w-6xl mx-auto overflow-hidden shadow-xl step bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl">
                    <div class="p-12">
                        ...
                        <div class="flex justify-end py-3">
                            ...
                            >
                                Next
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 ml-2 transition-transform duration-200 transform group-hover:translate-x-1" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="p-6 bg-white rounded-lg shadow-md step" id="step7">
                    ...
                    @include('livewire.dashboard.__parts.__summary')
    ...
    <script>
        ...
        switch (step) {
            ...
            if (_validate_step6()) {
                ...
                // showStep(currentStep);
                const urlParams = new URLSearchParams(window.location.search);
                urlParams.set('step', step + 1);  // Increase the step number and set it as a parameter

                // Optionally, you can add more parameters here
                urlParams.set('p', 'summary');  // Example of adding a custom parameter
        ...
        // Disable the button
        document.getElementById('submit_click')?.addEventListener('click', function() {
        ...
        function _validate_step1() {
            try {
                ...
                var dobInput = document.getElementById('mydob');
