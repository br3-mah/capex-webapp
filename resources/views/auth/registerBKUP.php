...
<body x-data="main"
    ...
    <div class="bg-[#f9fbfd] dark:bg-dark text-black min-h-screen relative z-10">
            ...
            <nav class="px-4 lg:px-7 py-4 max-w-[1440px] mx-auto">
                <div class="flex flex-wrap items-center justify-between">
                    <a href="index.php" class="flex items-center">
                        ...
                        <img src="public/app/img/logo-2.png" class="hidden mx-auto light-logo h-7 dark:block"
                            alt="logo">
                    </a>
                </div>
            </nav>
        ...
        <div
            class="min-h-[calc(100vh-134px)] py-4 px-4 sm:px-12 flex justify-center items-center max-w-[1440px] mx-auto">
            <div
                ...
                <x-jet-validation-errors class="mb-4 text-xs text-danger float-alert-bar"
                    style="color:rgb(255, 0, 0)" />

                <form id="registerForm" class="grid grid-cols-1 gap-4 sm:grid-cols-2" method="post"
                ...
                <p class="mt-5 text-center text-muted dark:text-darkmuted">Already a member? <a
                        href="{{ route('login') }}" class="text-black dark:text-white">Sign In</a></p>
            </div>
        </div>
    </div>
    <!-- Custom js -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const weakCombinations = ["1234", "0000", "1111", "2222", "3333", "4444", "5555", "6666", "7777",
            "8888", "9999"
        ];
        ...
        passwordInput.addEventListener('input', function(e) {
            ...
            if (value.length === 4) {
                ...
                if (!/(\d)\1{3}/.test(value) && !/(0123|1234|2345|3456|4567|5678|6789|7890)/.test(
                    value)) {
                    strength++;
                }
            }
