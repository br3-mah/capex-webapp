    ...
    <div class="container mx-auto p-4">
        <form action="{{ route('update-kyc-uploads') }}" method="POST" enctype="multipart/form-data" id="wizardForm" class="mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                          ...
                          <div>
                            ...
                            <input id="payslip_file" name="payslip_file" type="file" class="sr-only" required onchange="previewImage(this, 'payslip_preview')">
                    ...
                    @php
                        function getFileUrl($upload) {
                            return $upload->source === 'admin'
                                ...
                                : 'http://localhost/capex-app/public/' . Storage::url($upload->path);
                        }
            ...
            <div class='flex justify-end'>
                <button type='submit' class='px=6 py=3 bg-blue=600 text-white font-semibold rounded-md hover:bg-blue=700 transition duration=200'> Save Changes </button>
            </div>
